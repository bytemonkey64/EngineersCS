...
namespace Engineers
{
    class Components
    {
        ...
        public Components()
        {
            ComponentsList.Add(AberrantShieldPatternAnalysis);
            ComponentsList.Add(AbnormalCompactEmissionData);
            ComponentsList.Add(AdaptiveEncryptorsCapture);
            ComponentsList.Add(AnomalousBulkScanData);
            ComponentsList.Add(AnomalousFSDTelemetry);
            ComponentsList.Add(Antimony);
            ComponentsList.Add(Arsenic);
            ComponentsList.Add(ArticulationMotors);
            ComponentsList.Add(AtypicalDisruptedWakeEchoes);
            ComponentsList.Add(AtypicalEncryptionArchives);
            ComponentsList.Add(BasicConductors);
            ComponentsList.Add(BiotechConductors);
            ComponentsList.Add(Bromellite);
            ComponentsList.Add(Cadmium);
            ComponentsList.Add(Carbon);
            ComponentsList.Add(ChemicalDistillery);
            ComponentsList.Add(ChemicalManipulators);
            ComponentsList.Add(ChemicalProcessors);
            ComponentsList.Add(ChemicalStorageUnits);
            ComponentsList.Add(Chromium);
            ComponentsList.Add(ClassifiedScanDatabanks);
            ComponentsList.Add(ClassifiedScanFragment);
            ComponentsList.Add(CMMComposite);
            ComponentsList.Add(CompactComposites);
            ComponentsList.Add(CompoundShielding);
            ComponentsList.Add(ConductiveCeramics);
            ComponentsList.Add(ConductiveComponents);
            ComponentsList.Add(ConductivePolymers);
            ComponentsList.Add(ConfigurableComponents);
            ComponentsList.Add(CoreDynamicsComposites);
            ComponentsList.Add(CrackedIndustrialFirmware);
            ComponentsList.Add(CrystalShards);
            ComponentsList.Add(DataminedWakeExceptions);
            ComponentsList.Add(DecodedEmissionData);
            ComponentsList.Add(DistortedShieldCycleRecordings);
            ComponentsList.Add(DivergentScanData);
            ComponentsList.Add(EccentricHyperspaceTrajectories);
            ComponentsList.Add(ElectrochemicalArrays);
            ComponentsList.Add(EmergencyPowerCells);
            ComponentsList.Add(EnergyGridAssembly);
            ComponentsList.Add(ExceptionalScrambledEmissionData);
            ComponentsList.Add(ExhaustManifold);
            ComponentsList.Add(ExquisiteFocusCrystals);
            ComponentsList.Add(FilamentComposites);
            ComponentsList.Add(FlawedFocusCrystals);
            ComponentsList.Add(FocusCrystals);
            ComponentsList.Add(GalvanisingAlloys);
            ComponentsList.Add(Germanium);
            ComponentsList.Add(GridResistors);
            ComponentsList.Add(HardwareDiagnosticSensor);
            ComponentsList.Add(HeatConductionWiring);
            ComponentsList.Add(HeatConductors);
            ComponentsList.Add(HeatDispersionPlate);
            ComponentsList.Add(HeatExchangers);
            ComponentsList.Add(HeatResistantCeramics);
            ComponentsList.Add(HeatVanes);
            ComponentsList.Add(HeatsinkInterlink);
            ComponentsList.Add(HighDensityComposites);
            ComponentsList.Add(HNShockMount);
            ComponentsList.Add(HybridCapacitors);
            ComponentsList.Add(ImperialShielding);
            ComponentsList.Add(ImprovisedComponents);
            ComponentsList.Add(InconsistentShieldSoakAnalysis);
            ComponentsList.Add(InsulatingMembrane);
            ComponentsList.Add(IonDistributor);
            ComponentsList.Add(Iron);
            ComponentsList.Add(IrregularEmissionData);
            ComponentsList.Add(MagneticEmitterCoil);
            ComponentsList.Add(Manganese);
            ComponentsList.Add(MechanicalComponents);
            ComponentsList.Add(MechanicalEquipment);
            ComponentsList.Add(MechanicalScrap);
            ComponentsList.Add(Mercury);
            ComponentsList.Add(MicroControllers);
            ComponentsList.Add(MicroWeaveCoolingHoses);
            ComponentsList.Add(MilitaryGradeAlloys);
            ComponentsList.Add(MilitarySupercapacitors);
            ComponentsList.Add(ModifiedConsumerFirmware);
            ComponentsList.Add(ModifiedEmbeddedFirmware);
            ComponentsList.Add(ModularTerminals);
            ComponentsList.Add(Molybdenum);
            ComponentsList.Add(Nanobreakers);
            ComponentsList.Add(NeofabricInsulation);
            ComponentsList.Add(Nickel);
            ComponentsList.Add(Niobium);
            ComponentsList.Add(OpenSymmetricKeys);
            ComponentsList.Add(Osmium);
            ComponentsList.Add(PeculiarShieldFrequencyData);
            ComponentsList.Add(PharmaceuticalIsolators);
            ComponentsList.Add(PhaseAlloys);
            ComponentsList.Add(Phosphorus);
            ComponentsList.Add(Platinum);
            ComponentsList.Add(Polonium);
            ComponentsList.Add(PolymerCapacitors);
            ComponentsList.Add(PowerConverter);
            ComponentsList.Add(PowerTransferBus);
            ComponentsList.Add(Praseodymium);
            ComponentsList.Add(PrecipitatedAlloys);
            ComponentsList.Add(ProprietaryComposites);
            ComponentsList.Add(ProtoHeatRadiators);
            ComponentsList.Add(ProtoLightAlloys);
            ComponentsList.Add(ProtoRadiolicAlloys);
            ComponentsList.Add(RadiationBaffle);
            ComponentsList.Add(RefinedFocusCrystals);
            ComponentsList.Add(ReinforcedMountingPlate);
            ComponentsList.Add(Ruthenium);
            ComponentsList.Add(SalvagedAlloys);
            ComponentsList.Add(Samarium);
            ComponentsList.Add(SecurityFirmwarePatch);
            ComponentsList.Add(Selenium);
            ComponentsList.Add(ShieldEmitters);
            ComponentsList.Add(ShieldingSensors);
            ComponentsList.Add(SpecialisedLegacyFirmware);
            ComponentsList.Add(StrangeWakeSolutions);
            ComponentsList.Add(Sulphur);
            ComponentsList.Add(TaggedEncryptionCodes);
            ComponentsList.Add(Technetium);
            ComponentsList.Add(TelemetrySuite);
            ComponentsList.Add(Tellurium);
            ComponentsList.Add(TemperedAlloys);
            ComponentsList.Add(ThermicAlloys);
            ComponentsList.Add(Tin);
            ComponentsList.Add(Tungsten);
            ComponentsList.Add(UnexpectedEmissionData);
            ComponentsList.Add(UnidentifiedScanArchives);
            ComponentsList.Add(UnknownFragment);
            ComponentsList.Add(UntypicalShieldScans);
            ComponentsList.Add(UnusualEncryptedFiles);
            ComponentsList.Add(Vanadium);
            ComponentsList.Add(WornShieldEmitters);
            ComponentsList.Add(Yttrium);
            ComponentsList.Add(Zinc);
            ComponentsList.Add(Zirconium);
